...
export function DataLegacy({ entries }: DataLegacyProps) {
  return (
    <div className="max-w-3xl mx-auto px-6 py-8">
      <div className="mb-8">
        <h2 className="text-2xl mb-2 text-foreground">Data Legacy</h2>
      ...
      <div className="space-y-6">
        ...
        <Card className="p-6">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              <h3 className="font-medium mb-2 text-foreground">Where Your Data Lives</h3>
        ...
        <Card className="p-6">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              <h3 className="font-medium mb-2 text-foreground">Export Regularly</h3>
              <p className="text-sm text-muted-foreground mb-4">
        ...
        <Card className="p-6">
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              <h3 className="font-medium mb-2 text-foreground">Changing Devices or Browsers</h3>
              <p className="text-sm text-muted-foreground mb-4">
        ...
        {/* Long-term thinking */}
        <Card className="p-6 border-border bg-muted/40">
          <h3 className="font-medium mb-3 text-foreground">Long-Term Data Philosophy</h3>
          <div className="text-sm text-muted-foreground space-y-3">
            ...
            <p className="pt-3 border-t border-border mt-4">
        ...
        <Card className="p-6">
          <h3 className="font-medium mb-3 text-foreground">Passing Your Journal Forward</h3>
          <p className="text-sm text-muted-foreground mb-4">
          ...
          <p className="text-sm text-muted-foreground mt-4 italic opacity-70">
      ...
      <div className="mt-8 p-6 bg-card border border-border shadow-sm rounded-lg">
        <h3 className="font-medium mb-2 text-foreground">Remember</h3>
